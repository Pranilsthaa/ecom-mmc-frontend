          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                Join thousands of families who trust us to transform their
                wedding photos, family moments, and special occasions into
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3 p-4 bg-white/50 rounded-xl backdrop-blur-sm border border-white/30 shadow-sm">
                ...
                <div>
                  <h3 className="font-semibold text-gray-800">Welcome Bonus</h3>
                  <p className="text-sm text-gray-600">
                    Get 20% off your first memory frame order
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3 p-4 bg-white/50 rounded-xl backdrop-blur-sm border border-white/30 shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Personal design consultation for your memories
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3 p-4 bg-white/50 rounded-xl backdrop-blur-sm border border-white/30 shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Your memories protected for generations
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-start space-x-3">
                    <input
                      type="checkbox"
                      id="terms"
                      className="mt-1 w-4 h-4 text-rose-600 bg-gray-100 border-gray-300 rounded focus:ring-rose-500 focus:ring-2"
                      required
                    />
                    <label
                      htmlFor="terms"
