            ...
            <>
              ...
              <div className="card p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center cursor-pointer justify-between p-4 rounded-xl border border-red-200 hover:bg-red-50 transition-colors">
                    <div className="flex items-center gap-3">
                      ...
                      >
                        <h4 className="font-semibold text-red-700 text-left">
                          Sign Out
                        </h4>
